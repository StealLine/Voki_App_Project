<script lang="ts">
	...
	import AutoAlbumLink from './_c_auto_albums_section/AutoAlbumLink.svelte';
	import AutoAlbumsAppearanceEditingDialog from './_c_auto_albums_section/AutoAlbumsAppearanceEditingDialog.svelte';
