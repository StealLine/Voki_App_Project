<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<path
		...
		stroke-linejoin="round"
	/>
	<path d="M16 8L19 5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
	<path
		opacity="0.4"
	...
	<path
		...
		stroke-linejoin="round"
	/>
	<path d="M18.0009 2V2.02" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
	<path d="M22.0009 6V6.02" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
	<path
		d="M21.0009 13V13.02"
		stroke="currentColor"
		stroke-linecap="round"
		stroke-linejoin="round"
	/>
	<path d="M11.0009 3V3.02" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
</svg>
