...
public abstract partial record GeneralVokiQuestionContent
{
    public sealed record ImageAndText(
        ImmutableArray<BaseQuestionAnswer.ImageAndText> Answers
    ) : GeneralVokiQuestionContent
    {
        ...
        public override IEnumerable<BaseStorageKey> GatherContentKeys() => Answers.Select(a => a.Image as BaseStorageKey);
    }
}
